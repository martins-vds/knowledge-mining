...
namespace KnowledgeMining.UI.Services.Search
{
    ...
    public static partial class Extensions
    {
        ...
        {
            Type type;
            if (field.Type == SearchFieldDataType.Boolean) type = typeof(bool);
            ...
            else if (field.Type == SearchFieldDataType.Int32) type = typeof(int);
            else if (field.Type == SearchFieldDataType.Int64) type = typeof(long);
            ...
            else if (field.Type.ToString() == SearchFieldDataType.Collection(SearchFieldDataType.GeographyPoint).ToString()) type = typeof(GeographyPoint[]);
            else if (field.Type.ToString() == SearchFieldDataType.Collection(SearchFieldDataType.Double).ToString()) type = typeof(double[]);
            else if (field.Type.ToString() == SearchFieldDataType.Collection(SearchFieldDataType.Boolean).ToString()) type = typeof(bool[]);
            else if (field.Type.ToString() == SearchFieldDataType.Collection(SearchFieldDataType.Int64).ToString()) type = typeof(int[]);
            else if (field.Type.ToString() == SearchFieldDataType.Collection(SearchFieldDataType.Int64).ToString()) type = typeof(long[]);
            else
            {
