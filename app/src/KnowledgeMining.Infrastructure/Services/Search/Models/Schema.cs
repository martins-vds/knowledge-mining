...
namespace KnowledgeMining.UI.Services.Search.Models
{
    public class Schema
    {
        ...
        {
            Type? type = default;
            if (fieldType == SearchFieldDataType.Boolean)
            {
                type = typeof(bool);
            }
            ...
            else if (fieldType == SearchFieldDataType.GeographyPoint)
            {
            ...
            else if (fieldType.ToString() == SearchFieldDataType.Collection(SearchFieldDataType.String).ToString())
            {
                type = typeof(string[]);
            }
            ...
            else if (fieldType == SearchFieldDataType.Collection(SearchFieldDataType.Complex))
            {
                type = typeof(string[]);
            }
            else if (fieldType.ToString() == SearchFieldDataType.Collection(SearchFieldDataType.DateTimeOffset).ToString())
            {
                type = typeof(DateTime[]);
            }
            else if (fieldType.ToString() == SearchFieldDataType.Collection(SearchFieldDataType.GeographyPoint).ToString())
            {
                type = typeof(GeographyPoint[]);
            }
            else if (fieldType.ToString() == SearchFieldDataType.Collection(SearchFieldDataType.Double).ToString())
            {
                type = typeof(double[]);
            }
            else if (fieldType.ToString() == SearchFieldDataType.Collection(SearchFieldDataType.Boolean).ToString())
            {
                type = typeof(bool[]);
            }
            else if (fieldType.ToString() == SearchFieldDataType.Collection(SearchFieldDataType.Int32).ToString())
            {
                type = typeof(int[]);
            }
            else if (fieldType.ToString() == SearchFieldDataType.Collection(SearchFieldDataType.Int64).ToString())
            {
                type = typeof(long[]);
            }
